    ...
    _write_jsonl(
        ...
        [
            ...
            {"index_name": "SP500", "ticker": "JNJ", "added_date": "1973-01-01", "removed_date": None},
            {
                "index_name": "SP500",
                "ticker": "TWTR",
                "added_date": "2018-06-07",
                "removed_date": "2023-11-28",
            },
            {
                "index_name": "SP500",
                "ticker": "ENRNQ",
                "added_date": "1995-12-01",
                "removed_date": "2001-12-03",
            },
        ],
    )
    ...
    rows.append(
        {
            ...
            "end": "2025-09-30",
            "val": 9_000_000,
            "filed": "2025-09-15",  # filed mid-Q3, before Q ended
...
def seed_edgar_multi() -> None:
    ...
    for tkr, cik in [("AAPL", 320193), ("MSFT", 789019), ("GOOGL", 1652044), ("ABBV", 1800), ("JNJ", 14272)]:
        seed_edgar(tkr, cik)
        ...
        rows.append(
            {
                ...
                "num_analysts": 35,
                "growth": 0.08,
                "eps_trend_current": 1.50,
                "eps_trend_7d_ago": 1.48,
                "eps_trend_30d_ago": 1.45,
                "eps_trend_60d_ago": 1.42,
                "eps_trend_90d_ago": 1.40,
                "revisions_up_7d": 3,
                "revisions_down_7d": 1,
                "revisions_up_30d": 8,
                "revisions_down_30d": 3,
